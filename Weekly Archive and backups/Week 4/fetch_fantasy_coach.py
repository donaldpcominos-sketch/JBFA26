...
grab a fresh cookie from DevTools and provide it once via run_all.py
or place it in cookie.txt in this folder.
"""
...
from config import DEFAULT_USER_AGENT, get_cookie, get_current_round

# ── CONFIG ────────────────────────────────────────────────────────────────────

API_URL = "https://fantasy.nrl.com/data/nrl/coach/players.json"
COOKIE = get_cookie(required=True)
